...
public class SessaoAuthenticationFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    // O cookie é validado na entrada. O contexto não vira sessão HTTP nem é
    // compartilhado entre requisições; apenas acompanha o download assíncrono.
    new RequestAttributeSecurityContextRepository().saveContext(

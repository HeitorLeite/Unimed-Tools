/*
 * Responsabilidade: Expõe o contrato multipart do preenchimento de especialidades médicas.
 */
...
public class EspecialidadeController {
  ...
  public EspecialidadeController(EspecialidadeService svc) {
    this.svc = svc;
  }
  ...
  public ResponseEntity<byte[]> processar(
    ...
    String nomeArq =
      despesas.getOriginalFilename() != null
        ? despesas
            .getOriginalFilename()
            .replaceAll("\\.(xlsx|csv)$", "_PREENCHIDO.xlsx")

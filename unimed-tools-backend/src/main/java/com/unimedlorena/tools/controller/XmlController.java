/*
 * Responsabilidade: Expõe a implementação Java de análise XML, mantida separada do processamento do frontend.
 */
...
public class XmlController {
  ...
  public ResponseEntity<XmlAnaliseResponse> analisar(
    ...
    @RequestParam(defaultValue = "true") boolean removedor
  ) throws Exception {
    String content = new String(file.getBytes(), StandardCharsets.UTF_8);
    XmlAnaliseResponse response = xmlService.analisar(
      content,
      corretor,
      removedor
    );

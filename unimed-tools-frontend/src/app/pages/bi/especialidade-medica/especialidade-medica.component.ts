/**
 * Orquestra o preenchimento de especialidades a partir das planilhas selecionadas.
 */
...
export class EspecialidadeMedicaComponent {
  ...
  onDragOverD(e: DragEvent) {
    e.preventDefault();
    this.dragOverDespesas = true;
  }
  onDragLeaveD() {
    this.dragOverDespesas = false;
  }
  onDropD(e: DragEvent) {
    e.preventDefault();
    this.dragOverDespesas = false;
  ...
  onDragOverM(e: DragEvent) {
    e.preventDefault();
    this.dragOverMedicos = true;
  }
  onDragLeaveM() {
    this.dragOverMedicos = false;
  }
  onDropM(e: DragEvent) {
    e.preventDefault();
    this.dragOverMedicos = false;
  ...
  validar(f: File): boolean {
    return f.name.endsWith('.xlsx') || f.name.endsWith('.csv');
  }
  removerDespesas() {
    this.arquivoDespesas = null;
    this.reset();
  }
  removerMedicos() {
    this.arquivoMedicos = null;
    this.reset();
  }
